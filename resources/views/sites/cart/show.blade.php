                                            ...
                                            @foreach($product_carts as $product_cart)
                                                <tr class="cart_item">
                                                    ...
                                                    <td class="product-remove">
                                                        <a href="https://goatstee.com/cart/?remove_item=74686d33bfcb9b980ecea2df8d2b78dc&#038;_wpnonce=c9c44ab6b3"
                                                           class="remove" title="Remove this item"
                                                           data-product_id="2779250"
                                                    ...
                                                    <td class="product-name" data-title="Product">
                                                        ...
                                                        <dl class="variation">
                                                            ...
                                                            <dd class="variation-Color"><p>{{$product_cart->color}}</p>
                                                            </dd>
                                                            <dt class="variation-Size">Size:</dt>
                                                            <dd class="variation-Size"><p>{{$product_cart->size}}</p>
                                                            </dd>
                                                            <dt class="variation-FitType">Fit Type:</dt>
                                                            <dd class="variation-FitType">
                                                                <p>{{$product_cart->fit_type}}</p>
                                                            </dd>
                                                        </dl>
                                                    </td>
                                                ...
                                                <span class="woocommerce-Price-amount amount"><span
                                                            class="woocommerce-Price-currencySymbol">&#36;</span>{{$product_cart->product->price}}</span>
                                                    </td>
                                                ...
                                                <span class="woocommerce-Price-amount amount"><span
                                                            class="woocommerce-Price-currencySymbol">&#36;</span>{{$product_cart->price}}</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            ...
                                            <table cellspacing="0" class="shop_table shop_table_responsive">
                                                ...
                                                <tr class="order-total">
                                                    ...
                                                    <td data-title="Total"><strong><span
                                                                    class="woocommerce-Price-amount amount"><span
                                                                        class="woocommerce-Price-currencySymbol">&#36;</span>98.65</span></strong>
                                                    </td>
                                                </tr>
