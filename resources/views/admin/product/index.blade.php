                            ...
                            <tr>
                                ...
                                <td>
                                    @for($i = 1; $i < 5; $i++)
                                        ...
                                        <img src="{{getLinkImage($product[$index])}}" width="120px" height="120px">
                                        @endif
                                    @endfor
                                ...
                                <td>
                                    <a href="{{route('products.show', ['product' => $product->id])}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
